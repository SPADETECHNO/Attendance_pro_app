...
@immutable
class AttendanceThemeExtension
    extends ThemeExtension<AttendanceThemeExtension> {
  ...
  AttendanceThemeExtension lerp(
    ...
    return AttendanceThemeExtension(
      ...
      liveSessionColor:
          Color.lerp(liveSessionColor, other.liveSessionColor, t)!,
      upcomingSessionColor:
          Color.lerp(upcomingSessionColor, other.upcomingSessionColor, t)!,
      endedSessionColor:
          Color.lerp(endedSessionColor, other.endedSessionColor, t)!,
    );
  }
